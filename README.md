...
# Warning: Since version 1.1 the file cache as been moved to a client setting to not bloat your world data - before updating if you already have a file cache please follow the procedure below to clear it. If you already updated, you can downgrade, follow the procedure and update again.
